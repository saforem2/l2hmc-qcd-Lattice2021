...
Fig~\ref{fig:ridgeplots} (c.) that the trained sampler artificially
...
can be seen in Fig~\ref{fig:plaqsf_beta}.
% \footnote{%
...
%
\begin{figure}[htpb]
    \includegraphics[width=\linewidth]{assets/tint.pdf}
...
\begin{figure}[htpb]
    \centering
        \includegraphics[width=\linewidth]{assets/ridgeplots.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=\linewidth]{assets/plaqsf_vs_lf_step.pdf}
    \caption{\label{fig:plaqsf_beta}Plots illustrating how the average
    plaquette\(x_{P}\) deviates from the expected value during a trajectory.}
\end{figure}
%
