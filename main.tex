...
\abstract{
    ...
    topological charge when compared with traditional HMC, and investigatepropose methods
...
scaling up to full QCD remains challenging.
%
As the prefered method for full QCD,
HMC is our baseline here for performance comparison.
%
...
%
HMC sampler is known to have difficulty traversing
low-density zones,
as the energy conserving symplectic integrator moves the system state
in almost equal probabilities.
This prevents the system from ever going to low probability regions,
