...
outperform HMC at sampling the topology, (see e.g.~\cite{Eichhorn:2021ccz} for
a comparison), they are of limited practical use as they cannot be
straightforwardly applied to full QCD.\footnote{In contrast to the proposed
method which, at least in principle, is generally applicable}.
...
\bibliography{main,../../ZoteroLibrary1}
